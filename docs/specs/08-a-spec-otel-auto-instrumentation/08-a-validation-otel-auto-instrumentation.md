...
| **Unit 4: Tail-Based Sampling Configuration** | Deprecated - Removed | ⚠️ REMOVED: Sampling moved to OTel Collector. Application now uses ParentBasedSampler with AlwaysOnSampler (100% sampling). File `lib/otel/sampler.ts` deleted. See `08-a-addendum-sampling-removal.md`. Removal Commit: `6e3aaba` |
